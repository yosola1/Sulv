		...
		<div id="content">
			<div id="main">
				...
				<table width="0" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td><span
							style="display: inline-block; width: 200px; text-align: right;">用
								户 名：</span> <input id="userName" type="text" class="a" name="userName" ></input>
					...
					<tr>
						<td><span
							style="display: inline-block; width: 200px; text-align: right;">密
								码 ：</span> <input id="password" type="password" class="a"
							name="password" /></td>
					</tr>
					...
					<tr>
						<td><span	style="display: inline-block; width: 200px; text-align: right;">性别：</span><input id="nan" type="radio" name="sex" value="男"
							 />男<input id= "nv" type="radio" name="sex" value="女" />女
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="button" id="changekey" class="btn btn-primary" 
								style="margin-top: 50px; margin-left: 200px;" value="修改" />
