...
<link href="css/read_article.css" type="text/css" rel="stylesheet">
...
<script type="text/javascript" src="js/read_article.js"></script>
...
<div id="loginTitle" class="title" style="display: none"><!-- title -->
	...
	<div class="content"><!-- content -->
		<div class="contentLeft"><!-- 左侧（推荐文章） -->
			...
			<hr>
			<div id="commentForm" style="text-align: right;margin-top: 20px;"><!-- 添加评论 -->
				<textarea id="commentContent" class="form-control" rows="5"></textarea><br>
				<button class="btn btn-info" onclick="comment()">提交</button>
			</div>
		...
		<div class="contentRight"><!-- 右侧-->
			...
			<div id="user" class="user">
				...
				<label id="collection">收藏：0</label>&nbsp;&nbsp;<label id="like">喜欢：0</label>
			</div>
		</div>
</div>
<!-- --------------------------------------------------------- -->
